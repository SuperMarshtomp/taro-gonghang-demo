    ...
    return <View style={_styleSheet["home-recommend"]}>
        ...
        {isList ? <View style={_styleSheet["home-recommend__list"]}>
          ...
          return <View key={id} style={_styleSheet["home-recommend__list-item"]}>
                    ...
                    <Image onClick={this.handleShowDetail.bind(this, categoryItem)} src={categoryItem.listPicUrl} style={_styleSheet["home-recommend__list-item-img"]} />
          ...
          return <View key={id} style={_styleSheet["home-recommend__list2-item"]}>
                    <Image onClick={this.handleShowDetail.bind(this, categoryItem)} src={categoryItem.listPicUrl} style={_styleSheet["home-recommend__list2-item-img"]} />
